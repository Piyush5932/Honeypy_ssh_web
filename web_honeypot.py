...
def run_web_honeypot(port=5000, input_username="admin", input_password="password"):
    run__web_honeypot_app = web_honeypot(input_username, input_password)
    run__web_honeypot_app.run(debug=False, port=port, host="0.0.0.0")

    return run__web_honeypot_app
